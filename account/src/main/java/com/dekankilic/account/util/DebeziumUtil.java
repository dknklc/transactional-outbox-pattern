package com.dekankilic.account.util;

import com.dekankilic.account.service.OutboxService;
...
public class DebeziumUtil {
    ...
    // SourceRecord, veri degisiklikleri izleme ve yakalama araclarinda kullanilan bir siniftir.
